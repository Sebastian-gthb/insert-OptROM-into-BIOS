...
This Python code insert a Option ROM into a empty space on a BIOS ROM (for the era of 286 and 386 CPUs).
...
<img width="1667" height="726" alt="VisualizationRomImage" src="https://github.com/user-attachments/assets/e9885018-78ae-4bb0-b136-58865399fb69" />
...
Changes:
   ...
   * adding a script to visualize the BIOS ROM with free and not free blocks <-- solved!


### Example output of the script is:
```
Working directory = C:\Users\user\Documents\B310
Loading BIOS as HI and LO chip and merge both parts...
